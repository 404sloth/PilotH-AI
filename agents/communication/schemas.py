...
class MeetingRequestInput(BaseModel):
    ...
    preferred_time_range: Optional[str] = Field(None, description="e.g. '2024-09-10T09:00/2024-09-10T18:00'")
    timezone:             str           = Field("UTC")
    context:              Optional[str] = Field(None, description="Meeting purpose / agenda goals")
    meeting_id:           Optional[str] = Field(None, description="Existing meeting ID for summarize/brief")
    transcript:           Optional[str] = Field(None, description="Meeting transcript for summarization")
